...
import { deleteUser, setEditingUser, startEditing } from '../redux/slices/userSlice'



export function TableRow({user, openModal}: {user: User, openModal?: () => void}) {
